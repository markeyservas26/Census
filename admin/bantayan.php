...
$total_query = "SELECT COUNT(*) as total FROM house_leader WHERE municipality = 'Bantayan'";
if (!empty($search)) {
  ...
  <section class="sections">
    <div class="row">
        ...
        <tr>
            ...
            <td>
    <a href="view-household.php?id=<?= $row['id'] ?>" class="btn btn-primary btn-sm">View</a>

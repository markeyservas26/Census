  ...
  <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md text-center">
    ...
    <div id="countdownMessage" class="text-red-500 text-lg font-semibold hidden mb-4"></div>
      ...
      <div class="flex items-center">
        ...
        <label for="termsCheckbox" class="text-sm text-gray-600">Yes, I agree to the <a href="../admin/termsandconditions" class="text-blue-600 hover:underline">Terms & Conditions</a></label>
      </div>

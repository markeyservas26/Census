        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addStaffForm" class="row g-3" method="POST" action="../staffaction/manage-staff.php" novalidate onsubmit="return validatePassword()">
                    ...
                    <div class="col-md-6">
                        <div class="password-container" style="top: 5px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    ...
                    <input type="text" id="modal-password" class="form-control" placeholder="Enter staff password">
                </div>
            </div>
...
function validateStaffPassword() {
    ...
    const validStaffPassword = 'staff'; 

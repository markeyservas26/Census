...
function printElement(elementId) {
    ...
    if (printWindow) {
        ...
        printWindow.document.write('<img src="../assets/img/santafeseal.png" alt="Logo">'); // Replace with your logo path
        printWindow.document.write('<h4>REPUBLIC OF THE PHILIPPINES</h4>');
        printWindow.document.write('<h4>PROVINCE OF CEBU</h4>');
        printWindow.document.write('<h4>MUNICIPALITY OF SANTAFE</h4>');
